...
| [HerdR workspace source](herdr.md)         | Protocol-16/19 transport, generations, events, and source projection.         | [`src/herdr/`](../src/herdr/)                                                |
